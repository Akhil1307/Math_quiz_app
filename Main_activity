    ...
    public String NextQuestion(){
        ...
        switch (operatorIndex) {
            ...
            case 3:
                operator = "/";
                b = random.nextInt(4) ;
                // Calculate the maximum possible value for 'a' (numerator) divisible by 'b'
                a = b * (random.nextInt(5) );
                // Calculate the correct answer as the integer division of 'a' by 'b'
                correctAnswer = a / b;
                break;
            default:
                operator = "+";
        ...
        QuestionTextView.setText(a + operator + b);
...
public class MainActivity extends AppCompatActivity {
    TextView TimeTextView, ScoreTextView, AlertTextView, QuestionTextView, FinalScoreTextView, buttonPlayAgain;
    Button button0,button1,button2,button3, startBtn;
    CountDownTimer countDownTimer;
    ConstraintLayout constraintLayout;
    ConstraintLayout lastLayout;
    Random random =new Random();
    int a, b,indexOfCorrectAnswer,points = 0, totalQuestions = 0;
    ArrayList<Integer> answers = new ArrayList<Integer>();
    @SuppressLint("SetTextI18n")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
